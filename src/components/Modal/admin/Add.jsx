...
const updateCacheAdd = (cache, { data: { addAdmin } }) => {
  ...
  // const index = addAdmin.id;
  // console.log("index", index);
  console.log("admins", admins);
  console.log("addAdmin", addAdmin);
  // admins[index] = addAdmin;
  cache.writeQuery({
    query: GET_ADMINS,
    data: { admins: [...admins, addAdmin] }
    // data: { admins: admins.concat([addAdmin]) }
  });
};
...
class AddModal extends React.Component {
  ...
  saveAdmin(event, addAdmin, adm) {
    ...
    let { isError, admin } = adminValidation(
      adm,
      this.props.admin,
      "add"
    );
                  ...
                  >
                    <form>
                      <CustomInput
                        ...
                        inputProps={{ errorcomment: admin.usernameerror }}
                      />
                      <CustomInput
                        labelText="Correo"
                        name="email"
                        ...
                        formControlProps={{ fullWidth: true }}
                        onChange={this.handleChangeAdmin}
                        inputProps={{ errorcomment: admin.emailerror }}
                      />
                      <CustomInput
                        labelText="Password"
                        name="password"
                        ...
                        formControlProps={{ fullWidth: true }}
                        onChange={this.handleChangeAdmin}
                        inputProps={{ errorcomment: admin.passworderror }}
                      />
